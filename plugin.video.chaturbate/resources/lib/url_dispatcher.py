...
from resources.lib.basics import addDir, addDownLink, addImgLink, cum_image, addon
...
class URL_Dispatcher(object):
    ...
    def __init__(self, module_name):
        ...
        self.img_search = cum_image('miami-search.png')
        self.img_cat = cum_image('miami-cat.png')
        self.img_next = cum_image('miami-next.png')
        self.widget = False
